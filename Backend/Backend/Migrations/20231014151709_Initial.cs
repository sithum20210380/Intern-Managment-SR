        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Evolution1Score = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Evolution1Feedback = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Evolution2Score = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Evolution2Feedback = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EvaluatorEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EvaluationCriteria = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: false),
                    Weight = table.Column<double>(type: "float", nullable: false),
                    InternProfileId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EvaluationForms_AspNetUsers_EvaluatorId",
                        column: x => x.EvaluatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvaluationForms_InternProfiles_InternProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationForms_EvaluatorId",
                table: "EvaluationForms",
                column: "EvaluatorId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationForms_InternProfileId",
                table: "EvaluationForms",
